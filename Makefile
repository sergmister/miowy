...
#CC  = gcc -Wall -g
PROG = play
OBJ = $(PROG).o board.o connect.o genmove.o interact.o move.o shuff.o ui.o node.o vec.o

$(PROG): $(OBJ)
	$(CC) -o  $(PROG) $(OBJ)

$(PROG).o: $(PROG).cpp board.h connect.h genmove.h interact.h shuff.h ui.h vec.h
	$(CC) -c  $(PROG).cpp
...
genmove.o: board.h shuff.h genmove.h vec.h genmove.cpp
	$(CC) -c genmove.cpp
